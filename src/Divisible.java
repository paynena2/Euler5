	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			for(int y = 2; y < 21; y++) { //starting at 2 again
				counter++; // I want to count the amount of times this loops, if it hits 18, the number is divisible by 1->20
			...
			if(counter == 18) { //if the counter is 18, the number is divisible by 1-20
